...
FamilyTree.templates.tweet = Object.assign({}, FamilyTree.templates.myTemplate);
FamilyTree.templates.tweet.node += tweetSvg;
FamilyTree.templates.tweet.field_0 =
    "<text " +
    FamilyTree.attr.width +
    ' ="150" style="font-size: 16px;" fill="#6D8FB2" x="160" y="45" text-anchor="middle">{val}</text>';
FamilyTree.templates.tweet.field_1 =
    "<text " +
    FamilyTree.attr.width +
    ' ="230" style="font-size: 14px;" fill="#6D8FB2" x="160" y="70" text-anchor="middle">{val}</text>';
...
family.load([
    ...
    },
    {
        ...
        name: "Nastya",
        fName: "Vasileva",
        img: "https://cdn.balkan.app/shared/w60/5.jpg",
    },
    {
        id: 5,
        pids: [3],
        name: "Polya",
        fName: "Vasileva",
        img: "https://cdn.balkan.app/shared/w60/3.jpg",
        tags: ["left-partner"],
    },
    {
        id: 3,
        ...
        fid: 2,
        name: "Isai",
        img: "https://cdn.balkan.app/shared/m60/7.jpg",
        fName: "Vasilev",
    },
    {
        id: 4,
    ...
    },
    {
        ...
        name: "Yuliya",
        fName: "Vasileva",
        img: "https://cdn.balkan.app/shared/w30/6.jpg",
    },
    {
        id: 7,
        mid: 4,
