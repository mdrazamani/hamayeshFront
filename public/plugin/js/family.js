    ...
    (this._event_id = FamilyTree._guid()),
        FamilyTree._validateConfig(this.config) &&
            ...
            FamilyTree._intersectionObserver(this.element, function (e) {
                (i.isVisible = e),
                    !1 !==
                        FamilyTree.events.publish("visibility-change", [i]) &&
...
(FamilyTree._defaultConfig = function (e) {
        ...
        if (!FamilyTree.LAZY_LOADING || this.isVisible)
            if (
                ...
                this.manager.read(
                    ...
                    i,
                    function (n) {
                        if (!a.notifierUI.show(n.notif))
                            if (
                                !1 !== a.config.lazyLoading ||
                                !0 !== e ||
                                t === FamilyTree.action.exporting
                            ) {
                                t != FamilyTree.action.exporting &&
                                    ((a.nodes = n.nodes),
                                    (a.visibleNodeIds = n.visibleNodeIds),
                                    (a.roots = n.roots)),
                                    (a.editUI.fields = n.allFields);
                                var o = { defs: "" };
                                FamilyTree.events.publish("renderdefs", [a, o]);
                                var l = a.ui.defs(o.defs),
                                    s = a.getScale(n.viewBox);
                                l += a.ui.pointer(a.config, t, s);
                                var d = a.getViewBox(),
                                    c = n.viewBox;
                                o = { content: l, res: n };
                                FamilyTree.events.publish("prerender", [a, o]),
                                    (l = o.content);
                                for (
                                    var m = 0;
                                    m < n.visibleNodeIds.length;
                                    m++
                                ) {
                                ...
                                o = { content: l, res: n };
                                if (
                                    (FamilyTree.events.publish("render", [
                                        a,
                                        o,
                                    ]),
                                    (l = o.content),
                                    ...
                                    t === FamilyTree.action.centerNode
                                        ...
                                        a._initialized ||
                                            ((a._initialized = !0),
                                            a.filterUI.update(),
                                            FamilyTree.events.publish("init", [
                                                a,
                                            ])),
                                        !a._loaded &&
                                            n &&
                                            n.nodes &&
                                            Object.keys(n.nodes).length &&
                                            (a._loaded = !0);
                                } else {
                                    var T = n.boundary,
                                        v = T.maxX - T.minX,
    ...
    (FamilyTree.prototype.ripple = function (e, t, i) {
        ...
        if (null != r) {
            ...
            if (null != a) {
                ...
                u.setAttribute("id", T);
                var v = {
                    ripple: FamilyTree.t(r.templateName, r.min, this.getScale())
                        .ripple,
                    node: r,
                };
                FamilyTree.events.publish("ripple", [this, v]),
                    y.setAttribute("x", v.ripple.rect ? v.ripple.rect.x : 0),
                    y.setAttribute("y", v.ripple.rect ? v.ripple.rect.y : 0),
                    y.setAttribute(
                        "width",
                        v.ripple.rect ? v.ripple.rect.width : r.w
                    ),
                    y.setAttribute(
                        "height",
                        v.ripple.rect ? v.ripple.rect.height : r.h
                    ),
                    y.setAttribute("rx", v.ripple.radius),
                    y.setAttribute("ry", v.ripple.radius),
                    g.setAttribute("clip-path", "url(#" + T + ")"),
                    g.setAttribute("cx", o),
                    g.setAttribute("cy", l),
                    g.setAttribute("r", 0),
                    g.setAttribute("fill", v.ripple.color),
    ...
    (FamilyTree.prototype._showAfterAnimation = function () {
        ...
        var r = this.element.querySelectorAll(
            "[" + FamilyTree.attr.link_id + "]"
        );
    ...
    (FamilyTree.prototype._nodeHasHiddenParent = function (e) {
        return (
            ...
            !(
                !e.isPartner ||
                FamilyTree.isNEU(e.mid) ||
                !this.getNode(e.mid)
            ) ||
            !(
                !e.isPartner ||
                FamilyTree.isNEU(e.fid) ||
                !this.getNode(e.fid)
            ) ||
    ...
    (FamilyTree.prototype.center = function (e, t, i) {
        ...
        Array.isArray(this.config.roots) || (roots = []),
            FamilyTree._changeRootOption(
                this.config.roots,
                r,
                this.manager.rootList
            ),
            this._center(e, t, i);
    }),
    ...
    (FamilyTree.prototype.updateNode = function (e, t, i) {
        ...
        if (
            !0 === i &&
            !1 === FamilyTree.events.publish("update", [this, a, e])
        )
            return !1;
        this.update(e),
    ...
    (FamilyTree.prototype.removeNode = function (e, t, i) {
        ...
        if (
            !0 === i &&
            !1 === FamilyTree.events.publish("remove", [this, e, a])
        )
            return !1;
        return (
            this.remove(e),
    ...
    (FamilyTree.prototype.remove = function (e) {
        ...
        if (t) {
            ...
            for (var i = this.config.nodes.length - 1; i >= 0; i--)
                (this.config.nodes[i].pid != e &&
                    this.config.nodes[i].stpid != e) ||
                    ((this.config.nodes[i].pid = t.pid),
                    (this.config.nodes[i].stpid = t.stpid)),
                    this.config.nodes[i].id == e &&
    ...
    (FamilyTree.prototype.replaceIds = function (e, t) {
        this._replaceIds(e),
            this._draw(!1, FamilyTree.action.update, void 0, t);
    }),
    (FamilyTree.prototype._replaceIds = function (e) {
        ...
        if (Array.isArray(this.config.roots))
            for (i = 0; i < this.config.roots.length; i++)
                this.config.roots[i] == a && (this.config.roots[i] = n);
        if (this.nodes)
    ...
    (FamilyTree.prototype._get = function (e) {
        ...
        if (t) return t;
        if (
            (this.config.groupDottedLines.length ||
                this.config.dottedLines.length) &&
            !FamilyTree.isNEU(e) &&
            "string" == typeof e &&
            ...
            if (
                ((e = e.substring(i + "_balkan_id_".length)),
                (t = this.__get(e)))
            )
                return t;
        }
    ...
    (FamilyTree.prototype.addChildNode = function (e, t, i) {
        ...
        if (!e || (FamilyTree.isNEU(e.mid) && FamilyTree.isNEU(e.fid)))
            ...
            if (!0 === i)
                if (!1 === FamilyTree.events.publish("update", [this, a]))
                    return !1;
    ...
    (FamilyTree.prototype.addChildAndPartnerNodes = function (e, t, i, r, a) {
        ...
        if (!t || (FamilyTree.isNEU(t.mid) && FamilyTree.isNEU(t.fid)))
            ...
            if (!0 === a)
                if (!1 === FamilyTree.events.publish("update", [this, s]))
                    return !1;
    ...
    (FamilyTree.prototype.addPartnerAndParentNodes = function (e, t, i, r, a) {
        ...
        if (!FamilyTree.isNEU(t) && t.length)
            if (i) {
                ...
                if (!0 === a)
                    if (!1 === FamilyTree.events.publish("update", [this, c]))
                        return !1;
                    ...
                    n._draw(
                        ...
                        function () {
                            n.ripple(i.id),
                                r && r(),
                                !0 === a &&
                                    FamilyTree.events.publish("updated", [
                                        n,
                                        c,
                                    ]),
                                n.filterUI.update();
    ...
    (FamilyTree.prototype.addPartnerNode = function (e, t, i) {
        ...
        if (e && Array.isArray(e.pids) && 1 == e.pids.length) {
            ...
            if (!0 === i)
                if (!1 === FamilyTree.events.publish("update", [this, n]))
                    return !1;
            ...
            if (["mid", "fid"].has(t))
                if (FamilyTree.isNEU(e))
                    ...
                    Array.isArray(i.pids) &&
                        (1 != i.pids.length &&
                            console.error(
                                "addParentNode: data has to have one partner"
                            ),
                        (s = this.get(i.pids[0])),
                    ...
                    if (!0 === a)
                        if (
                            !1 ===
                            FamilyTree.events.publish("update", [this, d])
                        )
                            return !1;
    ...
    (FamilyTree.prototype.removeNode = function (e, t, i) {
        ...
        if (this.canRemove(e)) {
            ...
            r._fireUpdate_addUpdateRemove(c, i),
                -1 != (d = r.config.roots.indexOf(e)) &&
                    r.config.roots.splice(d, 1),
    ...
    (FamilyTree.prototype._fireUpdate_addUpdateRemove = function (e, t) {
        for (var i = 0; i < e.addNodesData.length; i++)
            this.add(e.addNodesData[i]);
                                ...
                                if (i[m][p]) {
                                    ...
                                    for (var b in g)
                                        v[b] =
                                            a((d * s - s) / r) * (T[b] - g[b]) +
                                            g[b];
                                    e[m].setAttribute("viewBox", v.toString());
                                }
                                break;
                            case "margin":
                                if (i[m][p]) {
    ...
    (FamilyTree.anim.inOutBack = function (e) {
        return e < 0
            ...
            : 0.5 *
              ((2 * e - 2) * (2 * e - 2) * (3.5949 * (2 * e - 2) + 2.5949) + 2);
    }),
    ...
    (FamilyTree.editUI.prototype.show = function (e, t, i) {
        ...
        this.obj.element.appendChild(a.element),
            ...
            this.obj.element
                ...
                .addEventListener("click", function (t) {
                    t.preventDefault(),
                        !1 !==
                            FamilyTree.events.publish("cancel", [
                                r,
                                { id: e },
                            ]) && r.hide();
                }),
            ...
            this.obj.element
                ...
                .addEventListener("click", function (t) {
                    ...
                    if (!1 !== i) {
                        ...
                        if (!1 === FamilyTree.events.publish("save", [r, o]))
                            return;
                        r.obj.updateNode(o.data, null, !0), r.hide();
                    }
                });
        for (
            var n = this.obj.element.querySelectorAll("[data-input-btn]"),
                o = 0;
            o < n.length;
            o++
        ) {
        ...
        this.obj.element
            ...
            .addEventListener("click", function (e) {
                ...
                a.focus(),
                    a.nextElementSibling.addEventListener(
                        "click",
                        function (e) {
                            e.stopPropagation(), e.preventDefault();
                            var i = a.value,
                                n = r.obj.element.querySelector(
                                    '[data-binding="' +
                                        FamilyTree._escapeDoubleQuotes(
                                            a.value
                                        ) +
                                        '"]'
                                );
                            if (FamilyTree.isNEU(i) || n) a.focus();
                                ...
                                a.parentNode.parentNode.parentNode.removeChild(
                                    ...
                                    t.parentNode.insertAdjacentHTML(
                                        "beforebegin",
                                        o.html
                                    ),
                                    (t.style.display = ""),
                                    FamilyTree.input.init(
                                        t.parentNode.previousSibling
                                    ),
            ...
            this.obj.element
                ...
                .addEventListener("click", function (t) {
                    for (
                        ...
                        i &&
                        i.hasAttribute &&
                        !i.hasAttribute("data-edit-from-btn");
                    ...
                    if (i && i.hasAttribute) {
                        ...
                        if (
                            !1 ===
                            FamilyTree.events.publish("button-click", [r, o])
                        )
                            return !1;
                        switch (n) {
                            case "edit":
    ...
    (FamilyTree.editUI.prototype._focusElement = function (e) {
        ...
        FamilyTree.isNEU(this.obj.config.editForm.focusBinding)
            ...
            : (t = this.obj.element.querySelector(
                  '[data-binding="' +
                      this.obj.config.editForm.focusBinding +
                      '"]'
              )),
            t &&
                (t.value &&
    ...
    (FamilyTree.editUI.prototype.content = function (e, t, i, r, a) {
        ...
        if (
            ...
            for (v = 0; v < f.tags.length; v++) I.classList.add(f.tags[v]);
        ...
        return (
            (I.innerHTML = `<div>\n                        <div class="bft-edit-form-header" ${C}>\n                            ${A}\n                            ${FamilyTree.editUI.renderHeaderContent(
                ...
                for (var e = "", i = 0; i < l.length; i++) {
                    ...
                    if (Array.isArray(r)) {
                        e +=
                            '<div class="bft-form-field-100 bft-form-fieldset">';
                        for (var a = 0; a < r.length; a++) {
                            var o = r[a],
                                s = FamilyTree.elements[o.type](
                                    u,
                                    o,
                                    "unset",
                                    t
    ...
    (FamilyTree.menuUI.prototype._show = function (e, t, i, r, a) {
        ...
        for (var s in (a = l.menu)) {
            ...
            void 0 === d &&
                (d = FamilyTree.icon[s]
                    ? FamilyTree.icon[s](24, 24, "#7A7A7A")
                    : ""),
        ...
        if ("" != o) {
            if (
                ...
                var m = FamilyTree._menuPosition(
                    e,
                    this.wrapper,
                    this.obj.getSvg()
                );
    ...
    (FamilyTree.circleMenuUI.prototype._show = function (e, t) {
        ...
        if (!FamilyTree.isNEU(a.nodeCircleMenuButton)) {
            var n = this.obj.getSvg(),
                ...
                h = this.obj.element.querySelector(
                    "[" +
                        FamilyTree.attr.control_node_circle_menu_wrraper_id +
                        "]"
                );
            if (
                ...
                for (
                    var y = 0,
                        ...
                        v = 2 * Math.PI * T,
                        b = v / g - (2 * a.nodeCircleMenuButton.radius + 2);
                    b < 0;
                ...
                for (var F in ((h = document.createElementNS(
                    "http://www.w3.org/2000/svg",
                    "g"
                )).setAttribute(
                    FamilyTree.attr.control_node_circle_menu_wrraper_id,
    ...
    (FamilyTree.circleMenuUI.prototype.hide = function () {
        ...
        for (e = this._linesInterval.length - 1; e >= 0; e--)
            clearInterval(this._linesInterval[e]),
                this._linesInterval.splice(e, 1);
        this._linesInterval = [];
    ...
    (FamilyTree.idb._open = function (e) {
        if (FamilyTree._browser().msie) e && e(!1);
            ...
            if (null == FamilyTree.idb.db) {
                var t = indexedDB.open(
                    FamilyTree.idb.dbName,
                    FamilyTree.idb.version
                );
    ...
    (FamilyTree.toolbarUI.prototype.init = function (e, t) {
        if (t) {
            ...
            var i = this.div.querySelector(
                    "[" + FamilyTree.attr.tlbr + '="plus"]'
                ),
                r = this.div.querySelector(
                    "[" + FamilyTree.attr.tlbr + '="minus"]'
                ),
                a = this.div.querySelector(
                    "[" + FamilyTree.attr.tlbr + '="fit"]'
                ),
                n = this.div.querySelector(
                    "[" + FamilyTree.attr.tlbr + '="fullScreen"]'
                ),
                o = this.div.querySelector(
                    "[" + FamilyTree.attr.tlbr + '="expand"]'
                ),
                l = this;
            i &&
                ...
                this.layouts &&
                    this.layouts.addEventListener("click", function (e) {
                        for (var t = e.target; t; ) {
                            if (
                                t.hasAttribute &&
                                t.hasAttribute(FamilyTree.attr.layout)
                            ) {
            ...
            e.addEventListener(
                ...
                ((i = function () {
                    for (; this.rippleContainer.firstChild; )
                        this.rippleContainer.removeChild(
                            this.rippleContainer.firstChild
                        );
                }),
                (r = 2e3),
                (a = void 0),
    ...
    (FamilyTree.wrapText = function (e, t) {
        ...
        if (
            ...
            for (var u = h.getComputedTextLength(), y = 2; u > c; )
                (h.textContent = e.substring(0, e.length - y)),
                    ...
                    y++;
            return y > 2
                ? `<title>${FamilyTree._escapeHtml(e)}</title>${h.textContent}`
        ...
        if (-1 != m.indexOf("multiline")) {
            var g = e.split(" "),
                T = h.getBBox().height;
            h.textContent = "";
            var v = document.createElementNS(p, "tspan"),
                b = document.createTextNode(g[0]);
            v.setAttributeNS(null, "x", l),
                v.setAttributeNS(null, "y", s),
                v.setAttributeNS(null, "text-anchor", d),
                v.appendChild(b),
                h.appendChild(v);
            y = 1;
            for (var F = 1, x = 1; x < g.length; x++) {
                var _ = v.firstChild.data.length;
                if (
                    ((v.firstChild.data += " " + g[x]),
                    v.getComputedTextLength() > c)
                ) {
                    if (
                        ((v.firstChild.data = v.firstChild.data.slice(0, _)),
                        F++,
                        a && F > a)
                    ) {
                        if (n && h.children.length == a) {
                            var w = h.children[a - 1].textContent;
                            h.children[a - 1].textContent =
                                w.substring(0, w.length - 3) + "...";
                        }
                        break;
                    }
                    (v = document.createElementNS(p, "tspan")).setAttributeNS(
                        null,
                        "x",
                        l
                    ),
                        v.setAttributeNS(null, "y", s + T * y),
                        v.setAttributeNS(null, "text-anchor", d),
                        (b = document.createTextNode(g[x])),
                        v.appendChild(b),
                        h.appendChild(v),
                        y++;
                }
            ...
            if (null != h.innerHTML) (k = h.innerHTML), (h.innerHTML = "");
                ...
                for (x = h.childNodes.length - 1; x >= 0; x--)
                    (S =
                        XMLSerializer().serializeToString(h.childNodes[x]) + S),
                        h.removeChild(h.childNodes[x]);
                k = S;
            }
            return k;
        }
    ...
    (FamilyTree._getPosition = function (e, t, i, r) {
        var a = { x: t.x, y: t.y };
        if (
            (null != i && (a.x = i), null != r && (a.y = i), e && 3 == e.length)
        ) {
    ...
    (FamilyTree.t = function (e, t, i) {
        ...
        if (null != i && r.scaleLessThen) {
            ...
            if (n.length > 0) {
                ...
                for (var d in s)
                    null == a && (a = Object.assign({}, r)), (a[d] = s[d]);
            }
        }
        return t
            ? null == a
    ...
    (FamilyTree.setNodeSize = function (e) {
        ...
        (e.w = t && t.size ? t.size[0] : 0),
            (e.h = t && t.size ? t.size[1] : 0);
    }),
                    ...
                    for (var i = "", r = 0; r < t.length; r++) {
                        ...
                        (a =
                            "reportsTo" == t[r]
                                ...
                                : null == e[t[r]]
                                ? ""
                                : e[t[r]]) instanceof Date &&
                            (a = a.toLocaleString());
                        var n = (a = null === a ? "" : a.toString()).replace(
                                /"/g,
                                '""'
                            ),
                            o = new RegExp('("|;|\n)', "g");
    ...
    (FamilyTree.getStParentNodes = function (e, t) {
        ...
        return (
            e.stParent &&
                (t.push(e.stParent),
                FamilyTree.getStParentNodes(e.stParent, t)),
            t
        );
    }),
            ...
            for (var c = 1; c < e.length; c++) {
                ...
                if (
                    ...
                    var f,
                        ...
                        T = o(h);
                    i
                        ? ((f = a(g, m.origPoint || y, t)),
                          (u = a(g, h.origPoint || T, t)))
                        : ((f = r(g, y, t)), (u = r(g, T, t))),
                        n(p, f),
                        (p.origPoint = g),
                        l.push(p);
            ...
            this._draw(!1, FamilyTree.action.exporting, r, function (r) {
                ...
                if ("svg" == e.ext)
                    if (t) t(e, a.innerHTML);
                        ...
                        (n = a.querySelector("svg")).classList.add(
                            "bft-" + i.config.mode
                        );
                        var l = {
                                content: a.innerHTML,
                            ...
                            s = FamilyTree.events.publish("exportstart", [
                                i,
                                l,
                            ]),
                        ...
                        if (
                            ...
                            l.styles &&
                                (a.childNodes[0].insertAdjacentHTML(
                                    "afterbegin",
                                    l.styles
                                ),
                        ...
                        if (
                            !1 ===
                            (s = FamilyTree.events.publish("exportend", [i, l]))
                        )
                            return !1;
                    ...
                    i._pages(e, a.querySelector("svg"), function (r) {
                        var n = {
                            ...
                            o = FamilyTree.events.publish("exportstart", [
                                i,
                                n,
                            ]),
                            l = i.element.querySelector("[data-bft-styles]");
                        if ((l && (n.styles += l.outerHTML), !1 === o))
                            return !1;
                            ...
                            t
                                ...
                                : ((n = JSON.stringify(n)),
                                  FamilyTree._ajax(
                                      ...
                                      "arraybuffer",
                                      function (t) {
                                          var r = FamilyTree.events.publish(
                                              "exportend",
                                              [i, t]
                                          );
                                          if (
                                              (FamilyTree.loading.hide(i),
                                              !1 === r)
                                          )
                                              return !1;
                                          FamilyTree._downloadFile(
    ...
    (FamilyTree.prototype.exportCSV = function (e) {
        var t = FamilyTree._defaultExportProfileOptionsForCSV_SVG_JSON(
                e,
                "csv"
            ),
        ...
        i
            ? ((r = []),
              FamilyTree._exportIterateForJSON_XML_CSV(this, i, t, r))
        ...
        if (!1 === FamilyTree.events.publish("exportstart", [this, a]))
            return !1;
    ...
    (FamilyTree.prototype._pagesA100 = function (e, t, i) {
        ...
        for (
            var p = c.w * (100 / i), h = c.h * (100 / i), f = o, u = l, y = [];
            f < s + o;
            ...
            for (; u < d + l; ) {
                var g = [f, u, p, h];
                (g = g.join()),
                    y.push({ vb: g, innerSize: c, size: m }),
                    (u += h);
            }
            (f += p), (u = l);
        }
    ...
    (FamilyTree.prototype._exportProfile = function (e, t) {
        ...
        if (!t) {
            if (!1 === FamilyTree.events.publish("exportstart", [i, s]))
                return !1;
    ...
    (FamilyTree._importSetColumnNames = function (e, t) {
        if (-1 == e.indexOf("id") || -1 == e.indexOf("pid")) {
            ...
            for (var f = 0; f < e.length; f++) {
                ...
                v.appendChild(u), p.appendChild(v);
            }
            ...
            for (f = 0; f < e.length; f++) {
                ...
                v.appendChild(u), T.appendChild(v);
            }
            ...
            (b.innerHTML = "Import"),
                ...
                (b.onclick = function () {
                    (a.style.display = "none"),
                        a._overlay &&
                            a._overlay.parentNode.removeChild(a._overlay);
    ...
    (FamilyTree.prototype._expCollHandler = function (e) {
        ...
        if (i.length) {
            if (
                !1 ===
                FamilyTree.events.publish("expcollclick", [this, !1, e, i])
            )
                return !1;
            this.expand(e, i, !1);
        } else {
            if (
                !1 ===
                FamilyTree.events.publish("expcollclick", [
                    this,
                    !0,
                    e,
                    t.childrenIds,
    ...
    (FamilyTree.prototype._globalClickHandler = function (e, t) {
        ...
        for (var l = t.target; l != e; ) {
            ...
            if (l.hasAttribute(FamilyTree.attr.node_id)) {
                (s = l.getAttribute(FamilyTree.attr.node_id)),
                    (d = this.getNode(s));
        ...
        if (n.draggable) {
            ...
            var v = function (e, t) {
                    if (null != e) {
                        ...
                        for (
                            var i = FamilyTree.getStParentNodes(o.getNode(c)),
                                r = 0;
                            r < i.length;
                            r++
                        ) {
                ...
                b = function (t) {
                    if (h) {
                        var i = FamilyTree._getClientXY(t),
                            r = t.target;
                        FamilyTree.isMobile() &&
                            (r = document.elementFromPoint(i.x, i.y)),
                            (i.x += T.x * d),
                            (i.y += T.y * d);
                ...
                F = function (t) {
                    if (
                        ...
                        p.classList &&
                            ...
                            p.classList.remove("bft-cursor-nodrop"),
                            p.classList.remove("bft-cursor-copy")),
                        p.removeEventListener(i.move, b),
            ...
            p.addEventListener(i.move, b),
                p.addEventListener(i.up, F),
                i.leave && p.addEventListener(i.leave, F);
        }
    }),
        ...
        if (this.config.enableDragDrop) {
            ...
            var y = function (e, t) {
                    if (null != e) {
                        ...
                        for (
                            var i = s.getNode(o),
                                r = FamilyTree.getStParentNodes(i),
                                a = 0;
                            a < r.length;
                            a++
                        ) {
                ...
                T = function (t) {
                    ...
                    if (
                        !1 ===
                        FamilyTree.events.publish("drop", [s, n.id, r.id, u, t])
                    )
                        return (
                            y(o, l),
                            d.removeChild(u),
            ...
            d.addEventListener(i.move, g),
                d.addEventListener(i.up, T),
                i.leave && d.addEventListener(i.leave, T);
        }
    }),
    ...
    (FamilyTree.prototype._commonClickHandler = function (e, t, i) {
        ...
        this.menuUI.hide(),
        this.nodeCircleMenuUI.hide(),
        i == FamilyTree.action.expandCollapse &&
            this.toggleExpandCollapse(e, t),
        i == FamilyTree.action.edit) &&
            (r = this.getNode(e)) &&
            (this.editUI.show(r.id), this.ripple(r.id, t.clientX, t.clientY));
        i == FamilyTree.action.details &&
            (r = this.getNode(e)) &&
            (this.editUI.show(r.id, !0),
            this.ripple(r.id, t.clientX, t.clientY));
    }),
    ...
    (FamilyTree.prototype.toggleExpandCollapse = function (e, t) {
        ...
        if (r.length) {
            if (
                !1 ===
                FamilyTree.events.publish("expcollclick", [this, !1, e, r])
            )
                return !1;
            this.expand(e, r, !1);
        } else {
    ...
    (FamilyTree.prototype._mouseDownHandler = function (e, t, i) {
        ...
        t.touches &&
            ...
            "pan" == s.type &&
                ...
                this._changeCursorOnPanStart(a, n, t));
        var d = function (e) {
    ...
    (FamilyTree.searchUI.prototype.init = function (e) {
        ...
        var c = function () {
                var e = t.instance.element.querySelectorAll(
                        "[data-search-item-id]"
                    ),
                    i = t.instance.element.querySelector(
                        '[data-selected="yes"]'
                    );
                null == i && e.length > 0
        ...
        if (e) {
            if (e.hasAttribute("data-search-item-id")) {
                ...
                if (this.input.value != FamilyTree.SEARCH_HELP_SYMBOL) {
                    var i = FamilyTree.events.publish("searchclick", [
                            this.instance,
                            t,
                        ]),
                        r = FamilyTree.events.publish("searchclick", [
                            this,
                            { nodeId: t },
                        ]);
    ...
    (FamilyTree.searchUI.prototype._search = function () {
        ...
        if (
            ...
            e = `<table border="0" cellspacing="0" cellpadding="0">\n                        <tbody>\n                            ${(function () {
                for (
                    var e = "", r = 0;
                    r < t.lastSearch.length &&
                    !(r >= FamilyTree.SEARCH_RESULT_LIMIT);
                    r++
                ) {
                    ...
                    FamilyTree.events.publish("add-item", [t, d]),
                        (e += d.html);
                }
                return e;
            })()}  \n                        </tbody>\n                    </table>`;
        ...
        for (
            var r = this.instance.element.querySelectorAll(
                    "[data-search-item-id]"
                ),
                a = 0;
            a < r.length;
                ...
                if (this.hasAttribute("data-search-item-id")) {
                    ...
                    if (t.input.value != FamilyTree.SEARCH_HELP_SYMBOL) {
                        ...
                        if ((!1 === i && (r = !1), !1 !== r)) {
                            ...
                            var a = t.instance.element.querySelector(
                                '[data-selected="yes"]'
                            );
            ...
            (s.state = d),
                ...
                (n && n.method && "fit" == n.method)
                    ...
                    : ((s.viewBox = s.state.vb),
                      ...
                      Array.isArray(s.state.roots) &&
                          (s.config.roots = s.state.roots));
            var c = s.maxX,
                m = s.maxY,
                p = s.minX,
                h = s.minY,
    ...
    (FamilyTree.manager.prototype._read = function (e, t) {
        ...
        null == o && (o = FamilyTree.local),
            o._setPositions(
                ...
                function (t) {
                    var o =
                        FamilyTree.manager._doNotChangePositionOfClickedNodeIfAny(
                            n,
                            a,
                            i.action,
                            i.actionParams,
    ...
    (FamilyTree.manager._initNode = function (e, t, i, r, a, n, o) {
        var l = o.manager.config,
            ...
            p = s[i || "base"];
        null == e.parent &&
            FamilyTree.manager._setCollpasedProperty(e, p, c, a, d, r - 1, m);
        for (var h = 0; h < e.childrenIds.length; h++) {
            var f = t[e.childrenIds[h]];
            if (
                (FamilyTree.manager._setCollpasedProperty(f, p, c, a, d, r, m),
                !f.collapsed)
            ) {
        ...
        var T = { node: e };
        FamilyTree.events.publish("node-initialized", [o, T]),
        ...
        if (
            ...
            if (
                ...
                ((FamilyTree.MIXED_LAYOUT_ALL_NODES &&
                    h.length > 1 &&
                    h.length == t.parent.children.length - f - u) ||
            ...
            ((FamilyTree.MIXED_LAYOUT_ALL_NODES &&
                ...
                h.length == t.parent.childrenIds.length - f - u) ||
                (!FamilyTree.MIXED_LAYOUT_ALL_NODES &&
                    h.length >
                        FamilyTree.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN)) &&
                (l[t.pid] = h);
    ...
    (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, o, l) {
        for (
            ...
            (m = FamilyTree.STRING_TAGS
                ...
                ? p.tags.slice(0)
                : []),
                l.filterUI.addFilterTag(p) && m.unshift("filter");
            ...
            FamilyTree.isNEU(p.ppid) || (u.ppid = p.ppid),
                ...
                null != i.orderBy &&
                    (u.order = FamilyTree.manager._getOrderFieldValue(
                        p,
                        i.orderBy
                    )),
                (e[p.id] = u),
        ...
        for (c = 0; c < s.length; c++) {
            var y = s[c],
                ...
                T = e[u.stpid],
                v = e[u.pid];
            if ((T || (u.stpid = null), v || (u.pid = null), T)) {
                var b = n ? n[T.id] : null;
                b && (T.min = b.min), T.stChildrenIds.push(u.id);
            } else
                v
                    ? (g && ((u.collapsed = g.collapsed), (u.min = g.min)),
                      v.childrenIds.push(u.id))
                    : (g && ((u.collapsed = g.collapsed), (u.min = g.min)),
                      t.push(u),
                      o.push(u.id));
    ...
    (FamilyTree.manager._createNodes = function (e) {
            ...
            for (var c = 0; c < t.roots.length; c++) {
                ...
                if (m && r == FamilyTree.action.centerNode) {
                    for (var p = m; null != p.pid || null != p.stpid; )
                        p =
                            null == p.pid && null != p.stpid
                                ? l[p.stpid]
                                : l[p.pid];
                    for (
                        var h = l[a.id];
                        (null != h.pid || null != h.stpid) && h != m;

                    )
                        h =
                            null == h.pid && null != h.stpid
                                ? l[h.stpid]
                                : l[h.pid];
                    p == h && (m = p);
                }
                if (m) {
                    ...
                    if (!f) {
                        if (!FamilyTree.isNEU(m.pid))
                            (ue = (T = l[m.pid]).childrenIds.indexOf(m.id)) >
                                -1 && T.childrenIds.splice(ue, 1);
                        s.push(m);
                    }
                }
            }
        ...
        if (
            ...
            for (var v = l[a.id]; v; ) {
                if (
                    ...
                    a.options.parentState ===
                        FamilyTree.COLLAPSE_PARENT_NEIGHBORS && v)
                )
                    for (c = 0; c < v.childrenIds.length; c++) {
                        (D = l[v.childrenIds[c]]).collapsed = !0;
                    }
            ...
            if (a.options.childrenState === FamilyTree.COLLAPSE_SUB_CHILDRENS)
                for (c = 0; c < v.childrenIds.length; c++) {
                    (F = l[v.childrenIds[c]]).collapsed = !1;
        ...
        for (c = 0; c < S.length; c++) {
            ...
            for (b = 0; b < I.length; b++) {
                A[(D = l[I[b]]).id]
                    ? g.children.push(D)
                    : g.children.splice(0, 0, D);
                for (var P = 0; P < D.childrenIds.length; P++)
                    B.push(D.childrenIds[P]);
            }
            var R = [];
            for (b = 0; b < N.length; b++) {
                A[(D = l[N[b]]).id]
                    ? g.children.push(D)
                    : g.children.splice(0, 0, D);
                for (P = 0; P < D.childrenIds.length; P++)
                    R.push(D.childrenIds[P]);
            }
        ...
        for (c = 0; c < w.length; c++) {
            var z = i[(g = l[w[c]]).lcn ? g.lcn : "base"];
            for (b = 0; b < g.subLevels; b++) {
                var H = new FamilyTree.node(
                ...
                if (
                    (FamilyTree.manager._initDinamicNode(H, g.lcn),
                    (T = g.parent))
                )
                    (ue = T.children.indexOf(g)) > -1 &&
                        (T.children.splice(ue, 1), T.children.splice(ue, 0, H)),
                        H.children.push(g),
                        (H.parent = T),
                        (g.parent = H),
                        (l[H.id] = H);
        ...
        for (var $ in _) {
            (T = l[$]).hasAssistants = !0;
            H = new FamilyTree.node(
                T.id + "_split_assitant_0",
                T.id,
                ["assistant"],
                "split"
            );
            FamilyTree.manager._initDinamicNode(H, T.lcn, !0), (l[H.id] = H);
            var j = [];
            for (b = T.children.length - 1; b >= 0; b--) {
                (D = T.children[b]).isAssistant
                    ? ((D.parent = null),
                      T.children.splice(b, 1),
                      j.splice(0, 0, D.id))
                    : D.isPartner ||
                      (D.parent &&
                          k[D.parent.id] &&
            ...
            for (b = j.length - 1; b >= 0; b--)
                if (b % 2 && b != j.length - 1) {
                    var V = new FamilyTree.node(
                        T.id + "_split_assitant_" + Y,
                        T.pid,
                        [],
                        "split"
                    );
                    FamilyTree.manager._initDinamicNode(V, T.lcn, !0),
                        (l[V.id] = V),
                        j.splice(b, 0, V.id),
                        Y++;
                } else b % 2 && j.splice(b, 0, H.id);
        ...
        if (Z || ee) {
            ...
            for (var $ in k) {
                for (var me = (T = l[$]); me.isSplit; ) me = l[me.pid];
                for (; me.isSubLevel; ) me = l[me.pid];
                if ((z = i[T.lcn ? T.lcn : "base"]).layout > 0 || ee) {
                    (te.pnode = T),
                        (te.layout = z.layout),
                        (te.childrenIds = k[$]),
                    ...
                    for (var pe = 0; pe < te.layouts.length; pe++) {
                        ...
                        for (
                            FamilyTree.isNEU(he.subLevels) &&
                                (he.subLevels = 0),
                                FamilyTree.isNEU(he.layout) &&
                                    (he.layout = z.layout),
                                me = T = l[$];
                            me.isSplit;
                        ...
                        for (b = 0; b < he.subLevels; b++) {
                            H = new FamilyTree.node(
                                pe + "_sublevel_layout_" + b,
                                fe.id,
                                [],
                                "subLevel"
                            );
                            FamilyTree.manager._initDinamicNode(H, fe.lcn),
                                (H.parent = fe),
                                fe.children.push(H),
                                (l[H.id] = H),
                                (fe = H);
                        ...
                        if (he.subLevels) {
                            for (b = 0; b < he.childrenIds.length; b++) {
                                ...
                                -1 != (ue = T.children.indexOf(D)) &&
                                    T.children.splice(ue, 1),
                                    (D.parent = fe),
                                    fe.children.push(D);
                            }
                            T = fe;
                        ...
                        if (he.layout == FamilyTree.layout.mixed) {
                            ...
                            FamilyTree.manager._initDinamicNode(H, T.lcn),
                                (l[H.id] = H),
                                (H.layout = he.layout);
                            var Te = [];
                            for (c = he.childrenIds.length - 1; c >= 0; c--) {
                                for (
                                    D = l[he.childrenIds[c]], b = 0;
                                    b < T.children.length;
                                    b++
                                )
                                    T.children[b].id == D.id &&
                                        T.children.splice(b, 1);
                                if (
                                    ((D.parent = null),
                                    (D.layout = he.layout),
                                    ...
                                    var ve = new FamilyTree.node(
                                        pe + "_" + D.id + "_mirror",
                                        me.id,
                                        [],
                                        "mirror"
                                    );
                                    FamilyTree.manager._initDinamicNode(
                                        ve,
                                        D.lcn
                                    ),
                                        (ve.layout = he.layout),
                                ...
                                he.layout !=
                                    FamilyTree.layout.treeRightOffset &&
                                    he.layout != FamilyTree.layout.treeRight &&
                                    Te.splice(0, 0, D.id);
                            }
                            for (Y = 1, b = Te.length - 1; b >= 0; b--)
                                if (b % 2 && b != Te.length - 1) {
                                    ...
                                    FamilyTree.manager._initDinamicNode(
                                        ...
                                        Te.splice(b, 0, V.id),
                                        Y++;
                                } else b % 2 && Te.splice(b, 0, H.id);
                            for (b = 0; b < Te.length; b += 3) {
                                W = null;
                                0 == b && (W = T);
                                (G = l[Te[b]]),
                                    (J = l[Te[b + 1]]),
    ...
    (FamilyTree.manager._getResponse = function (
        ...
        if (
            ...
            if (x - 2 * r.padding >= a - o)
                ...
                switch (
                    ((w =
                        u.x -
                        x / 2 +
                        FamilyTree.manager._getNodeWidth(u, r) / 2),
                    r.orientation)
                ) {
                    case FamilyTree.orientation.right:
                    case FamilyTree.orientation.right_top:
                        (w = -(x / 2 - (o - a) / 2)) < r.padding - x &&
                            (w = r.padding - x);
                        break;
                    case FamilyTree.orientation.left:
                    case FamilyTree.orientation.bottom_left:
            ...
            if (_ - 2 * r.padding >= n - l)
                ...
                switch (
                    ((k = -(_ / 2 - (n - l) / 2)) > -r.padding &&
                        (k = -r.padding),
                    r.orientation)
                ) {
                    case FamilyTree.orientation.bottom:
                    case FamilyTree.orientation.bottom_left:
                        (k = -(_ / 2 - (l - n) / 2)) < r.padding - _ &&
                            (k = r.padding - _);
                        break;
                    case FamilyTree.orientation.left:
                    case FamilyTree.orientation.right:
        ...
        if (
            ...
            if (
                ...
                (C = p[m.id]), (C = FamilyTree.manager._getMostDeepChild(C, p));
        ...
        for (var N = 0; N < d.length; N++)
            FamilyTree.manager._iterate2(d[N], p, r, s, c, m, y, h, i, T);
        return {
            animations: T,
            boundary: g,
            viewBox: s,
        ...
        if (FamilyTree.manager._isVisible(e, i, r, a)) {
            ...
            if (
                ...
                if (((c = { x: (f = l[e.id]).x, y: f.y }), f)) {
                    c = { x: f.x, y: f.y };
                    for (var m = e, p = null; null != m; )
                        l[m.id] && l[m.id].collapsed && (p = m), (m = m.parent);
                ...
                if (
                    ((c = { x: (f = l[e.id]).x, y: f.y }), "all" == n.ids && f)
                ) {
                    c = { x: f.x, y: f.y };
                    for (m = e, p = null; null != m; )
                        l[m.id] && l[m.id].collapsed && (p = m), (m = m.parent);
                    p && p.parent && (c = { x: p.parent.x, y: p.parent.y });
                }
                if ((u = t[n.id])) {
                    for (
                        m = e.parent;
                        null != m &&
                        -1 == n.ids.indexOf(e.id) &&
                        -1 == n.ids.indexOf(m.id);
    ...
    (FamilyTree.manager._doNotChangePositionOfClickedNodeIfAny = function (
        ...
        var l = t[o],
            s = a[o];
        return s
            ? { x: (s.x ? s.x : 0) - l.x, y: (s.y ? s.y : 0) - l.y }
            : { x: 0, y: 0 };
    }),
    (FamilyTree.manager._verticalAssistantIterate = function (e, t) {
        ...
        if (e.isAssistant && e.isSplit && e.children.length) {
            for (
                var r = e.parent.children[0],
                    a = e.parent.children[2],
                    n = e.parent;
                !n.hasAssistants;
            ...
            if (d.length) {
                for (
                    ...
                    var f = e.children[h];
                    m.children.unshift(f),
                        (f.parent = m),
                        e.children.splice(h, 1);
                }
                e.children.push(p), (p.parent = e);
            }
        }
    }),
    (FamilyTree.manager._verticalAssistantLevelCountIterate = function (
        e,
        t,
        i
    ) {
                ...
                for (o = 0; o < t.length; o++)
                    if (t[o].id == a.from) {
                        ...
                        if (
                            ...
                            for (var s = 0; s < a.tags.length; s++)
                                c.tags.push(a.tags[s]);
                        t.push(c);
                        break;
                    }
            }
                ...
                for (o = 0; o < t.length; o++)
                    if (t[o].id == d.from) {
                        ...
                        if (
                            ...
                            for (s = 0; s < d.tags.length; s++)
                                c.tags.push(d.tags[s]);
                        t.push(c);
                        break;
                    }
            }
    ...
    (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, o, l) {
        for (
            ...
            (h = FamilyTree.STRING_TAGS
                ...
                ? f.tags.slice(0)
                : []),
                l.filterUI.addFilterTag(f) && h.push("filter");
            var u = l.searchUI.addMatchTag(f.id);
            !0 === u ? h.unshift("match") : !1 === u && h.unshift("no-match"),
                f.gender && h.push(f.gender);
            ...
            (g.ftChildrenIds = []),
                ...
                null != i.orderBy &&
                    (g.order = FamilyTree.manager._getOrderFieldValue(
                        f,
                        i.orderBy
                    )),
                (e[f.id] = g),
        ...
        for (p = 0; p < d.length; p++) {
            ...
            if (v) {
                var b = [];
                FamilyTree.manager._iterateSetRootIds(v.id, v.id, m, c, e, b),
                    o.push(b);
            }
        }
        ...
        for (p = 0; p < i.roots.length; p++)
            FamilyTree.manager._iterateFT(i.roots[p], m, c, e, n, t, r, a, i);
    }),
        ...
        if (o) {
            ...
            if (i[o.id])
                for (l = 0; l < i[o.id].length; l++)
                    FamilyTree.manager._iterateSetRootIds(
                        i[o.id][l],
                        t,
                        i,
                        r,
    ...
    (FamilyTree.manager._iterateFT = function (e, t, i, r, a, n, o, l, s) {
        ...
        if (
            ...
            h
                ? f &&
                  (h.tags.has("partner") ||
                      h.tags.has("left-partner") ||
                      h.tags.has("right-partner"))
        ...
        for (var y = 0; y < c.pids.length; y++) {
            ...
            if (g) {
                ...
                if (
                    ...
                    o == FamilyTree.action.init &&
                        (g.min = FamilyTree._getMin(g, s)),
                    l && m && T && l.id == c.id
                        ? T.hasPartners && 1 == m.isPartner
                            ? g.tags.push("left-partner")
                            : (T.hasPartners && 2 == m.isPartner) ||
                              1 == m.isPartner
                    ...
                    for (var v = 0; v < i[g.id].length; v++) {
                        var b = r[i[g.id][v]];
                        b &&
                            (FamilyTree.isNEU(b.fid) ||
                                FamilyTree.isNEU(b.mid)) &&
                            FamilyTree.manager._iterateFT(
                                i[g.id][v],
                                t,
                                i,
                                r,
        ...
        if (t[e])
            for (v = 0; v < t[e].length; v++)
                FamilyTree.manager._iterateFT(t[e][v], t, i, r, a, n, o, l, s);
        if (i[e])
            for (v = 0; v < i[e].length; v++)
                FamilyTree.manager._iterateFT(i[e][v], t, i, r, a, n, o, l, s);
    }),
    (FamilyTree.manager.getAllFields = function (e) {
        var t = [FamilyTree.TAGS];
        for (var i in e.nodeBinding) t.push(e.nodeBinding[i]);
    ...
    (FamilyTree.templates.mother = Object.assign(
        {},
        FamilyTree.templates.base
    )),
    ...
    (FamilyTree.templates.wife = Object.assign(
        {},
        FamilyTree.templates.mother
    )),
    ...
    (FamilyTree.templates.cgroup = Object.assign(
        {},
        FamilyTree.templates.base
    )),
    ...
    (FamilyTree.ui = {
        ...
        node: function (e, t, i, r, a, n, o, l, s, d) {
            ...
            c.defs &&
                (m = m.replaceAll(
                    "{randId}",
                    FamilyTree.ui._defsIds[e.templateName]
                )),
            ...
            var v = FamilyTree._getPosition(i, e, a, n),
                b = "node";
        ...
        link: function (e, t, i, r, a, n) {
            ...
            e.layout > 0 && (c = l.mixedHierarchyNodesSeparation / 2);
            var m = 0,
                    ...
                    (y = e.children[u]).parentPartner
                        ? ((f.ppnodes[y.id] = y.parentPartner),
                          ...
                          1 == y.parentPartner.isPartner
                              ? (-1 == f.rightIds.indexOf(y.parentPartner.id) &&
                                    f.rightIds.push(y.parentPartner.id),
                                (f.indexes[y.id] = f.rightIds.indexOf(
                                    y.parentPartner.id
                                )),
                                f.firstRight || (f.firstRight = y))
                              : 2 == y.parentPartner.isPartner &&
                                (-1 == f.leftIds.indexOf(y.parentPartner.id) &&
                                    f.leftIds.push(y.parentPartner.id),
                                (f.indexes[y.id] = f.leftIds.indexOf(
                                    y.parentPartner.id
                                )),
                                (f.lastLeft = y)))
                        : y.isPartner ||
            ...
            for (u = 0; u < e.children.length; u++) {
                var y = e.children[u],
                    ...
                    v = (s = FamilyTree.t(y.templateName, y.min, i)).link;
                    ...
                    switch (l.orientation) {
                        ...
                        case FamilyTree.orientation.top_left:
                            var b =
                                1 == y.layout
                                    ? void 0
                                    : g.minY - (g.minY - h.maxY) / 2;
                            T = FamilyTree.ui._linkTopToBottom(
                                y.parentPartner,
                                y,
                                s,
                                c,
                        ...
                        case FamilyTree.orientation.bottom_left:
                            b =
                                1 == y.layout
                                    ? void 0
                                    : g.maxY - (g.maxY - h.minY) / 2;
                            T = FamilyTree.ui._linkBottomToTop(
                                y.parentPartner,
                                y,
                                s,
                                c,
                        ...
                        case FamilyTree.orientation.right_top:
                            b =
                                1 == y.layout
                                    ? void 0
                                    : g.maxX - (g.maxX - h.minX) / 2;
                            T = FamilyTree.ui._linkRightToLeft(
                                y.parentPartner,
                                y,
                                s,
                                c,
                        ...
                        case FamilyTree.orientation.left_top:
                            b =
                                1 == y.layout
                                    ? void 0
                                    : g.minX - (g.minX - h.maxX) / 2;
                            T = FamilyTree.ui._linkLeftToRight(
                                y.parentPartner,
                                y,
                                s,
                                c,
                ...
                if (-1 != v.indexOf("{rounded}"))
                    if (
                        ...
                        v = v.replace(
                            "{rounded}",
                            "M" + T.xa + "," + T.ya + " L" + T.xd + "," + T.ya
                        );
                    else {
                        var _ = FamilyTree.ui._roundedEdge(
                                T.xa,
                                T.ya,
                                T.xb,
                                T.yb,
                ...
                var k = { node: e, cnode: y, p: T, html: v, action: n };
                FamilyTree.events.publish("render-link", [t, k]),
                    d.push(k.html);
                var S = "";
        ...
        menuButton: function (e) {
            return null == e.menu
                ? ""
                : FamilyTree.t(e.template, !1).menuButton.replaceAll(
                      "{p}",
                      e.padding
                  );
        },
            ...
            return (
                1 == n.isPartner
                    ? ((o =
                          ...
                          ((e.rightIds.length - 1) *
                              e.partnerChildrenSplitSeparation) /
                              2),
    ...
    (FamilyTree.pdfPrevUI._handler = function (e, t, i) {
        ...
        for (
            ...
            if (y) {
                var T = o - y.offsetHeight - 7;
                y.style.bottom = T + "px";
            }
            p.close();
        }
        var v = e.element.querySelector("#bft-ppdf-content");
        FamilyTree.animate(
            v,
            { opacity: 0 },
            { opacity: 1 },
    ...
    (FamilyTree._exportHtml = function (e, t, i, r, a, n, o, l) {
        for (var s = "", d = 0; d < i.margin.length; d++)
            s += i.margin[d] + "px ";
        var c =
        ...
        for (var i = "", r = 0; r < this.config.clinks.length; r++) {
            ...
            if (
                ...
                var T = _(m, p, g),
                    v = a.template;
                v || (v = "orange");
                var b = FamilyTree.clinkTemplates[v];
                if (a.label) {
                    var F = FamilyTree.clinkLabelPosition(a, m, p, T);
                    i += b.label
                        .replace("{x}", F.x)
                        .replace("{y}", F.y)
                        .replace("{val}", a.label);
            ...
            function _(e, t, i) {
                ...
                return (
                    (n =
                        (n / (Math.sqrt(r * r + a * a) * i)) *
                        FamilyTree.CLINK_CURVE),
    ...
    (FamilyTree.prototype._slinks = function (e, t) {
        ...
        function n(t, n, o) {
            ...
            if (t.sl == n.sl)
                switch (((d = n), p.orientation)) {
                    ...
                    case FamilyTree.orientation.top_left:
                        s.push([u.p, u.q]),
                            ...
                            s.push([
                                d.x + d.w / 2 + h.expandCollapseSize,
                                s[s.length - 1][1],
                            ]),
                    ...
                    case FamilyTree.orientation.left_top:
                        (u.p = t.x),
                            ...
                            s.push([
                                s[s.length - 1][0],
                                d.y + d.h / 2 + h.expandCollapseSize,
                            ]),
                ...
                for (; null == d; ) {
                    ...
                    if (
                        (v.id == n.id
                            ? (d = v)
                            : FamilyTree._intersects(v, u, p) &&
                              ((u = FamilyTree._addPoint(v, s, p, u, c)),
                              (T = !0)),
                        v.id != n.id)
                    ) {
                        for (; b; ) {
                            ...
                            FamilyTree._intersects(b, u, p) &&
                                ((u = FamilyTree._addPoint(b, s, p, u, c)),
                                (T = !0)),
                                (b = b.leftNeighbor);
                        }
                        for (; F; ) {
                            ...
                            FamilyTree._intersects(F, u, p) &&
                                ((u = FamilyTree._addPoint(F, s, p, u, c)),
                                (T = !0)),
                                (F = F.rightNeighbor);
                        }
                    }
                        ...
                        if (v.parent) {
                            (f = p.levelSeparation),
                                v.parent.layout &&
                                    (f = p.mixedHierarchyNodesSeparation);
                            var w =
                                e.manager.bordersByRootIdAndLevel[g.id][
                                    v.parent.sl
                                ];
                            switch (p.orientation) {
                                case FamilyTree.orientation.top:
            ...
            if (
                ((pathStr = FamilyTree.roundPathCorners(
                    s,
                    FamilyTree.LINK_ROUNDED_CORNERS,
                    !1
                )),
    ...
    FamilyTree.events.on("redraw", function (e, t) {
        if (e.config.groupDottedLines.length) {
            for (
                var i = e.element.querySelectorAll(
                        "[data-ctrl-n-dotted-close]"
                    ),
                    r = 0;
                r < i.length;
                r++
    ...
    (FamilyTree.prototype._putInUndoStack = function () {
        if (this.config.undoRedoStorageName) {
            var e =
                `${this.config.undoRedoStorageName}_undo_` +
                this.undoStepsCount();
    ...
    (FamilyTree.prototype._putInRedoStack = function () {
        if (this.config.undoRedoStorageName) {
            var e =
                `${this.config.undoRedoStorageName}_redo_` +
                this.redoStepsCount();
            sessionStorage.setItem(
                e,
                JSON.stringify({
            ...
            if (!1 !== FamilyTree.events.publish("change", [this, t])) {
                ...
                if (!i || !r) {
                    ...
                    a.classList.add("bft-undo-redo"),
                        ...
                        (i =
                            this.instance.element.querySelector("[data-undo]")),
                        (r =
                            this.instance.element.querySelector("[data-redo]")),
                        i.addEventListener("click", function () {
                            e.instance.undo();
                        }),
                        r.addEventListener("click", function () {
                ...
                t.undoStepsCount > 0
                    ? (i.classList.add("bft-ur-clickable"),
                      (i.querySelector(".bft-undo-i").innerHTML =
                          t.undoStepsCount),
                      (i.querySelector(".bft-undo-i").style.display =
                          "inline-block"))
                    : (i.classList.remove("bft-ur-clickable"),
                      (i.querySelector(".bft-undo-i").style.display = "none")),
                    t.redoStepsCount > 0
                        ? (r.classList.add("bft-ur-clickable"),
                          (r.querySelector(".bft-redo-i").innerHTML =
                              t.redoStepsCount),
                          (r.querySelector(".bft-redo-i").style.display =
                              "inline-block"))
            ...
            if (e.manager.action != FamilyTree.action.move) {
                (FamilyTree.miniMap._settings._scale = Math.min(
                    ...
                    (FamilyTree.miniMap._settings._translateX =
                        -e.response.boundary.minX *
                            FamilyTree.miniMap._settings._scale +
                        (FamilyTree.miniMap.width -
                            (e.response.boundary.maxX -
                                e.response.boundary.minX) *
                                FamilyTree.miniMap._settings._scale) /
                            2),
                    (FamilyTree.miniMap._settings._translateY =
                        -e.response.boundary.minY *
                            FamilyTree.miniMap._settings._scale +
                        (FamilyTree.miniMap.height -
                            (e.response.boundary.maxY -
                                e.response.boundary.minY) *
                                FamilyTree.miniMap._settings._scale) /
                            2);
                var i = e.getViewBox();
                    ...
                    (l.onmousemove = function (t) {
                        if (s) {
                            ...
                            var c = l.getBoundingClientRect(),
                                m = c.left,
                                p = c.top;
                            (n = parseInt(t.clientX - m)),
                                (o = parseInt(t.clientY - p));
                            var h =
                                    (n - r) /
                                    FamilyTree.miniMap._settings._scale,
                                f =
                            ...
                            (i[0] = h + i[0]),
                                ...
                                FamilyTree.miniMap._drawRectSelectorCanvas(
                                    e,
                                    i
                                ),
                                (r = n),
                    ...
                    r++,
                        a.includes(n.id) ||
                            (1 == r
                                ...
                                : 3 == r &&
                                  (i.fillStyle = FamilyTree.miniMap.colors[2]),
                            i.beginPath(),
                            i.fillRect(n.x, n.y, n.w, n.h),
                            i.strokeRect(n.x, n.y, n.w, n.h),
                            a.push(n.id)),
    ...
    (FamilyTree.miniMap._init = function (e) {
        if (!e.element.querySelector('[data-id="mini-map"]')) {
            ...
            (i.width = FamilyTree.miniMap.width),
                ...
                (i.style.left = 0);
            var r = document.createElement("div");
            r.setAttribute("data-id", "mini-map"),
            ...
            e._addEvent(r, "DOMMouseScroll", s),
                e._addEvent(r, "mousewheel", s);
            var d = 0,
                c = 0,
                m = function (e) {
                    var t = e.clientX - d,
    ...
    (FamilyTree._search.search = function (e, t, i, r, a, n, o) {
        ...
        if (o && d.length > 1) {
            var c = d[0];
            o[c] &&
                ((i = [o[c]]), (d = (s = s.replace(c, "").trim()).split(" ")));
        }
        ...
        for (var m = {}, p = 0; p < e.length; p++)
            for (var h = e[p], f = 0; f < i.length; f++) {
                ...
                if (!FamilyTree.isNEU(h[u])) {
                    ...
                    if (
                        null !=
                        (t = FamilyTree._search.searchAndComputeScore(
                            d,
                            y,
                            u,
                            n
                        ...
                        if (m[g]) {
                            if (m[g] && m[g] < t.__score) {
                                ...
                                for (var T = l.length - 1; T >= 0; T--)
                                    l[T].id == g && l.splice(T, 1);
                                FamilyTree._search.addNodeToResult(
                                    l,
                                    r,
                                    h,
                                    t,
    ...
    (FamilyTree._search.addNodeToResult = function (e, t, i, r, a, n) {
        ...
        null != r &&
            ...
            FamilyTree.isNEU(o.__searchMarks) &&
                (o.__searchMarks = r.__searchMarks)),
            e.push(o);
    }),
    (FamilyTree._search.searchAndComputeScore = function (e, t, i, r) {
        ...
        if (n.length) {
            ...
            for (h = 0; h < n.length; h++)
                if (
                    ((l += n[h].length),
                    n[h].start < s && (s = n[h].start),
                    h >= 1 && n[h - 1].start > n[h].start)
                ) {
                    d = 0;
                    break;
                }
        ...
        for (h = n.length - 1; h >= 0; h--)
            v = (v = v.insert(n[h].start + n[h].length, "</mark>")).insert(
                n[h].start,
                "<mark>"
            );
        return { __searchMarks: v, __score: T };
    }),
        ...
        if (l && !FamilyTree.isNEU(a) && 0 != a.length) {
            ...
            if (l.writeToUrlParams) {
                ...
                c.has(s.paramScale)
                    ...
                    c.has(s.paramX)
                        ? c.set(s.paramX, d.x)
                        : c.append(s.paramX, d.x),
                    c.has(s.paramY)
                        ? c.set(s.paramY, d.y)
                        : c.append(s.paramY, d.y),
                    c.has(s.paramExp)
        ...
        if (e) {
            ...
            if (e.readFromUrlParams) {
                ...
                if (
                    ...
                    ((m = [])[0] = s),
                        ...
                        (o.roots = null),
                        n.has(a.paramRoots) &&
                            (o.roots = n.get(a.paramRoots).split("*")),
            ...
            e.readFromIndexedDB &&
                FamilyTree.idb.read(e.name, function (a, n) {
                    if (0 == a)
                        console.error("Cannot read from - " + e.name), r(null);
        ...
        return a.doNotRender
            ...
            : {
                  html: `<div class="bft-form-field" style="min-width: ${i};">\n                    <div class="bft-input" data-bft-input="" ${
                      ...
                      a.binding
                  )}" ${a.readOnlyAttribute} maxlength="256" id="${
                      a.id
                  }" name="${
                      a.id
    ...
    (FamilyTree.elements._vidrf = function (e, t, i) {
        ...
        if (
            ...
            "select" != t.type || Array.isArray(t.options)
                ...
                : (r.options = []),
            (r.value =
                e && !FamilyTree.isNEU(e[t.binding]) ? e[t.binding] : ""),
            i && r.options)
        )
    ...
    (FamilyTree.input.initWithTimeout = function () {
        FamilyTree.input._timeout &&
            ...
            (FamilyTree.input._timeout = null)),
            (FamilyTree.input._timeout = setTimeout(
                FamilyTree.input.init,
                200
            ));
    }),
    ...
    (FamilyTree.input.validate = function (e) {
        ...
        return a && "" == t.value
            ? ((i.innerHTML +=
                  '<span class="bft-validation-error-message">&nbsp;' +
                  a +
                  "</span>"),
    ...
    (FamilyTree.prototype.hideTreeMenu = function (e, t) {
        if (this._tree_menu_temp) {
            ...
            if (
                ...
                (this.manager.bordersByRootIdAndLevel =
                    i.bordersByRootIdAndLevel),
        ...
        for (g = 0; g < l.length; g++)
            ((l[g].fid == c.id && FamilyTree.isNEU(l[g].mid)) ||
                ...
                (l[g].fid == c.id
                    ...
                    : l[g].mid == c.id &&
                      (l[g].fid = "_ft_partner_for_single_child"),
                m.push(l[g]),
                T.push(l[g].id));
        if (T.length) {
            var v = {
            ...
            "male" == c.gender
                ? ((v.templateName = "wife"),
                  (v._ft_partnerData.gender = "female"))
                : "female" == c.gender &&
                  ((v.templateName = "husband"),
                  (v._ft_partnerData.gender = "male")),
                c.pids.push(v.id),
                m.push(v);
        }
    ...
    (FamilyTree.filterUI.prototype.update = function () {
        if (this.instance.config.filterBy) {
            ...
            if ("all" == this.instance.config.filterBy)
                for (
                    var t = FamilyTree.manager.getAllFields(
            ...
            if (null != this.filterBy)
                for (var s in e)
                    if (this.filterBy[s])
                        for (var d in e[s])
                            this.filterBy[s][d] &&
                                (e[s][d] = this.filterBy[s][d]);
            this.filterBy = e;
            var c = this;
            (this.element =
                this.instance.element.querySelector("[data-filter]")),
                this.element &&
                ...
                this.instance.config.undoRedoStorageName
                    ...
                    : ((this.element.style.top =
                          this.instance.config.padding + "px"),
                    ...
                    if (
                        ...
                        for (
                            var t = e.target.getAttribute("data-filter-field"),
                                i =
                                    c.instance.element.querySelectorAll(
                                        "[data-filter-menu]"
                                    ),
                                r = 0;
                            r < i.length;
                        ...
                        var n = c.instance.element.querySelector(
                            "[data-filter-close]"
                        );
                        if (
                        ...
                        if (!o) {
                            ...
                            for (var d in c.filterBy[t]) {
                                ...
                                null == p && (p = d),
                                    ...
                                    FamilyTree.events.publish("add-item", [
                                        c,
                                        l,
                                    ]),
                                    (s += l.html);
                            ...
                            for (r = 0; r < h.length; r++)
                                h[r].addEventListener("change", function (e) {
                                    for (
                                        var t = e.target;
                                        t &&
                                        !t.hasAttribute("data-filter-menu");

                                    )
                                        t = t.parentNode;
                                    if (t) {
                                        var i =
                                            t.getAttribute("data-filter-menu");
                        ...
                        (o.style.display = "block"),
                            ...
                            FamilyTree.events.publish("show-items", [
                                c,
                                { name: t },
                            ]);
                    }
                          ...
                          FamilyTree._ajax(t, "post", s, "json", function (t) {
                              t.error
                                  ...
                                  : (FamilyTree.remote._proceed(e, t, r, i),
                                    FamilyTree.localStorage.setItem(
                                        s,
                                        JSON.stringify(t)
                                    ));
                          });
